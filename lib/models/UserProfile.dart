...
class UserProfile extends Model {
  ...
  const UserProfile._internal({required this.id, required userName, email, imageKey, description}): _userName = userName, _email = email, _imageKey = imageKey, _description = description;
  
  factory UserProfile({String? id, required String userName, String? email, String? imageKey, String? description}) {
  ...
  UserProfile copyWith({String? id, String? userName, String? email, String? imageKey, String? description}) {
    return UserProfile(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'userName': _userName, 'email': _email, 'imageKey': _imageKey, 'description': _description
  };
